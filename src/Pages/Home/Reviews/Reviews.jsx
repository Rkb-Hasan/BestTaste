            ...
            <div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-3 md:gap-8">
              <blockquote className="rounded-lg bg-inherit p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-[#FAFAFA]">
                  Exceptional! I've dined at many places, but none compare to
                  the exquisite experience offered here. Every bite is a
                  symphony of flavors, meticulously crafted to perfection. The
                  ambiance, service, and, above all, the food, leave an
                  indelible mark. Simply outstanding!
                </p>
              </blockquote>
              ...
              <blockquote className="rounded-lg bg-inherit p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-[#FAFAFA]">
                  ...
                  catering to diverse palates. The attention to detail is
                  evident in every dish, and the friendly staff add to the
                  overall charm. A culinary delight not to be missed!
                </p>
              </blockquote>
              ...
              <blockquote className="rounded-lg bg-inherit p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-4 text-[#FAFAFA]">
                  ...
                  you're greeted with warmth and aromas that transport you to
                  food heaven. Each dish tells a tale of passion and
                  craftsmanship. An absolute must-visit for any food enthusiast!
                </p>
              </blockquote>
            </div>
          </div>
